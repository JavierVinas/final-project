...
#Creating a new entry with the processed info
    new_record = [timestamp, numero_factura, 'Fenie Energía', fecha_facturacion, periodo_facturacion, total_factura, URL]
...
def webhook():
    ...
    print(response)
    pdf, url = reading_pdf(response)
    print(pdf)
    new_entry = processed_info(pdf, url)
    print(new_entry)
